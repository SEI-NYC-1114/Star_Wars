...
mv *.txt ~/Star_Wars/star_wars/empire/death_star
...
mv chewbacca.txt ~/Star_Wars/star_wars/empire/death_star/millenium_falcon && mv han_solo.txt ~/Star_Wars/star_wars/empire/death_star/millenium_falcon && mv luke_skywalker.txt ~/Star_Wars/star_wars/empire/death_star/millenium_falcon && mv princess_leia.txt ~/Star_Wars/star_wars/empire/death_star/millenium_falcon
