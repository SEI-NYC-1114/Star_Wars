...
# Move the whole crew from the millenium_falcon directory into the death_star directory. HINT:
# * following a directory will grab all files/folders inside of a directory (directory/*)
mv ./*.txt ../
...
mv han_solo.txt chewbacca.txt luke_skywalker.txt princess_leia.txt millenium_falcon/ 
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon ../../rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into 
#the empire directory!
