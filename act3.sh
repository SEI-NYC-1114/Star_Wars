...
cd death_star mv han_solo.txt chewbacca.txt princess_leia.txt luke_skywalker.txt millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
cd millenium_falcon mv millenium_falcon rebellion
...
cd death_star rm -rf death_star