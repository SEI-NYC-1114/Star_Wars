...
cat > star_wars/rebellion/princess_leia.txt
...
touch star_wars/rebellion/millenium_falcon/han_solo.txt touch star_wars/rebellion/millenium_falcon/chewbacca.tx
